...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-hall-a00d)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/round-hall-a00d#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/round-hall-a00d
```

A live public deployment of this template is available at [https://round-hall-a00d.templates.workers.dev](https://round-hall-a00d.templates.workers.dev)
